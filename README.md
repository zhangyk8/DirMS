...
- Paper Reference: [Kernel Smoothing, Mean Shift, and Their Learning Theory with Directional Data](https://jmlr.org/papers/v22/20-1194.html). Journal of Machine Learning Research, 22(154):1-92, 2021. \[[ArXiv Version](https://arxiv.org/abs/2010.13523)\]
...
- [Ray](https://ray.io/) (Fast and simple distributed computing API for Python and Java)
...
- E. Garcı́a-Portugués. Exact risk improvement of bandwidth selectors for kernel density estimation with directional data. _Electronic Journal of Statistics_, 7:1655–1685, 2013.
